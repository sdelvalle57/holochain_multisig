...
export const ERC20_THEME_NAME: string = process.env.REACT_APP_ERC20_THEME_NAME || 'DEFAULT_THEME';

export const ERC721_THEME_NAME: string = process.env.REACT_APP_ERC721_THEME_NAME || 'DARK_THEME';
